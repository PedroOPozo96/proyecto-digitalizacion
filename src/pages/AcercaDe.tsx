    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20">
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/90 rounded-lg shadow-lg">
              <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20">
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-lg">
...
{/* Sección 3: Anuncio de Video - Eliminada */}
<div className="mb-20">
  <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg shadow-lg">
